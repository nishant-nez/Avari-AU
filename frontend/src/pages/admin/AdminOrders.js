        ...
        <>
            ...
            <div className='w-full h-full flex flex-col items-center justify-center'>
                <div className="container mx-auto flex pt-36 justify-between items-center px-6">
                    <h1 className="text-xl font-semibold text-center">All Orders</h1>
                    <Link
                        to="http://dashboard.stripe.com/payments"
                        ...
                        <div className="w-full overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody className="bg-white">
                                    { orders.map((order) => {
                                        return (
                                            <OrderRow order={ order } key={ order.id } openModal={ openModal } name='admin' />
                                        );
                                    }) }
