...
const { getProducts, getProduct, getProductsByCategory, getProductsByVendor, addProduct, updateProduct, updateProductImage, deleteProduct } = require("../controllers/productController");
